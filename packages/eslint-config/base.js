 ...
 * the colour and register rules for UI surfaces, so every package's
 * eslint.config.js is one call and cannot silently opt out.
 *
...
export function defineConfig({ package: packageName }) {
  return [
    ...
    ...uiSurfaceConfigsFor(packageName),
