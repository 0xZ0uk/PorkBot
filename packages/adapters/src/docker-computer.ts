 ...
 * swap with it. The disk figure is a write-layer budget, not a floor: see
 * `diskQuota` for when the daemon actually enforces it and `disk-quota.ts`
 * for the drivers that answer it.
 */
